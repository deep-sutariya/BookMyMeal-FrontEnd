            ...
            <BrowserRouter>
              <Routes>
                ...
                >
                  ...
                  <Route
                    path="orders"
                    element={<Orders setNavType={setNavType} />}
                  />
                  <Route
                    path="reservation"
                    element={<Reservations setNavType={setNavType} />}
                  />
                  <Route
                    path="login"
                    element={<Login setNavType={setNavType} />}
                  />
                  <Route path="forgot-password" element={<Forgot_Pass />} />
                  <Route
                    path="signup"
                    element={<Signup setNavType={setNavType} />}
                  />
                  <Route
                    path="restaurentmenu"
                    element={<RestaurantMenu setNavType={setNavType} />}
                  />

                  <Route
                    path="restaurenthome"
                    element={<RestaurantHome setNavType={setNavType} />}
                  >
                    <Route
                      path=""
                      element={<Profile setNavType={setNavType} />}
                    />
                    <Route
                      path="menus"
                      element={<AllMenu menu={menu} setNavType={setNavType} />}
                    />
                    <Route
                      path="restaurantorders"
                      element={<RestaurantOrders setNavType={setNavType} />}
                    />
                    <Route
                      path="mediator"
                      element={<MediatorPage setNavType={setNavType} />}
                    />
                  </Route>

                  <Route
                    path="mediatorhome"
                    element={<MediatorHome setNavType={setNavType} />}
                  >
                    <Route
                      path="additem"
                      element={<MediatorForm setNavType={setNavType} />}
                    />
                    <Route
                      path="restaurant"
